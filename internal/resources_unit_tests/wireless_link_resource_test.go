...
func TestWirelessLinkResource(t *testing.T) {
	...
	if r == nil {
		...
		t.Fatal("Expected non-nil wireless link resource")
...
func TestWirelessLinkResourceSchema(t *testing.T) {
	...
	optionalAttrs := []string{"ssid", "status", "tenant", "auth_type", "auth_cipher", "auth_psk", "distance", "distance_unit", "description", "comments", "tags", "custom_fields"}
...
func TestWirelessLinkResourceConfigure(t *testing.T) {
	...
	r := resources.NewWirelessLinkResource().(*resources.WirelessLinkResource)
