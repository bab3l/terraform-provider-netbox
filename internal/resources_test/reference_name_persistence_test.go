		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("netbox_device.test", "device_type", deviceTypeName), // Model name
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("netbox_rack.test", "rack_type", rackTypeName), // Model name
...
func TestAccReferenceNamePersistence_RouteTarget(t *testing.T) {
	...
	tenantName := testutil.RandomName("tenant")
	tenantSlug := testutil.RandomSlug("tenant")
	routeTargetName := "65000:1" // Standard format for Route Target
