...
// TestAccCircuitTerminationResource_CustomFieldsPreservation verifies that custom fields set outside
...
// Helper functions for circuit termination resource tests
...
resource "netbox_circuit_termination" "test" {
  ...
  custom_fields = [
    {
      name  = netbox_custom_field.circuit_termination_pres.name
      type  = "text"
