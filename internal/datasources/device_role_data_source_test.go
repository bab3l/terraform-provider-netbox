...
func TestDeviceRoleDataSource(t *testing.T) {
	d := NewDeviceRoleDataSource()
	if d == nil {
		t.Fatal("DeviceRole data source should not be nil")
	}
}
...
func TestDeviceRoleDataSourceSchema(t *testing.T) {
	...
	expectedAttrs := []string{"id", "name", "slug", "color", "vm_role", "description", "tags", "custom_fields"}
...
func TestDeviceRoleDataSourceMetadata(t *testing.T) {
	...
	expectedTypeName := "netbox_device_role"
