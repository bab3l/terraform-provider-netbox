...
func TestConsolePortTemplateDataSource(t *testing.T) {
	d := NewConsolePortTemplateDataSource()
	if d == nil {
		t.Fatal("ConsolePortTemplate data source should not be nil")
	}
}
...
func TestConsolePortTemplateDataSourceMetadata(t *testing.T) {
	...
	expectedTypeName := "netbox_console_port_template"
