...
func TestVirtualChassisDataSource(t *testing.T) {
	d := NewVirtualChassisDataSource()
	if d == nil {
		t.Fatal("VirtualChassis data source should not be nil")
	}
}
...
func TestVirtualChassisDataSourceSchema(t *testing.T) {
	...
	expectedAttrs := []string{"id", "name", "domain", "master", "description", "comments", "member_count", "tags", "custom_fields"}
...
func TestVirtualChassisDataSourceMetadata(t *testing.T) {
	...
	expectedTypeName := "netbox_virtual_chassis"
