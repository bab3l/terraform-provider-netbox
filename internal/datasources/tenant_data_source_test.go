...
func TestTenantDataSource(t *testing.T) {
	d := NewTenantDataSource()
	if d == nil {
		t.Fatal("Tenant data source should not be nil")
	}
}
...
func TestTenantDataSourceSchema(t *testing.T) {
	...
	expectedAttrs := []string{"id", "name", "slug", "group", "description", "tags", "custom_fields"}
...
func TestTenantDataSourceMetadata(t *testing.T) {
	...
	expectedTypeName := "netbox_tenant"
