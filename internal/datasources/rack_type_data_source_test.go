...
func TestRackTypeDataSource(t *testing.T) {
	d := NewRackTypeDataSource()
	if d == nil {
		t.Fatal("RackType data source should not be nil")
	}
}
...
func TestRackTypeDataSourceSchema(t *testing.T) {
	...
	expectedAttrs := []string{"id", "manufacturer", "model", "slug", "description", "form_factor", "width", "u_height", "tags"}
...
func TestRackTypeDataSourceMetadata(t *testing.T) {
	...
	expectedTypeName := "netbox_rack_type"
