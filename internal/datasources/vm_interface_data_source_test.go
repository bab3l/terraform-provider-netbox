...
func TestVMInterfaceDataSource(t *testing.T) {
	d := NewVMInterfaceDataSource()
	if d == nil {
		t.Fatal("VMInterface data source should not be nil")
	}
}
...
func TestVMInterfaceDataSourceSchema(t *testing.T) {
	...
	expectedAttrs := []string{"id", "name", "virtual_machine", "enabled", "description", "tags", "custom_fields"}
...
func TestVMInterfaceDataSourceMetadata(t *testing.T) {
	...
	expectedTypeName := "netbox_vm_interface"
