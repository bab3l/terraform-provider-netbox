...
func TestInterfaceDataSource(t *testing.T) {
	d := NewInterfaceDataSource()
	if d == nil {
		t.Fatal("Interface data source should not be nil")
	}
}
...
func TestInterfaceDataSourceSchema(t *testing.T) {
	...
	expectedAttrs := []string{"id", "name", "device", "type", "enabled", "description", "tags", "custom_fields"}
...
func TestInterfaceDataSourceMetadata(t *testing.T) {
	...
	expectedTypeName := "netbox_interface"
