...
func TestPowerOutletTemplateDataSource(t *testing.T) {
	d := NewPowerOutletTemplateDataSource()
	if d == nil {
		t.Fatal("PowerOutletTemplate data source should not be nil")
	}
}
...
func TestPowerOutletTemplateDataSourceSchema(t *testing.T) {
	...
	expectedAttrs := []string{"id", "device_type", "module_type", "name", "label", "type", "power_port", "feed_leg", "description"}
...
func TestPowerOutletTemplateDataSourceMetadata(t *testing.T) {
	...
	expectedTypeName := "netbox_power_outlet_template"
