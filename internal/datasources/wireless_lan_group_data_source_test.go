...
func TestWirelessLANGroupDataSource(t *testing.T) {
	d := NewWirelessLANGroupDataSource()
	if d == nil {
		t.Fatal("WirelessLANGroup data source should not be nil")
	}
}
...
func TestWirelessLANGroupDataSourceSchema(t *testing.T) {
	...
	expectedAttrs := []string{"id", "name", "slug", "description", "parent_id", "parent_name", "tags"}
...
func TestWirelessLANGroupDataSourceMetadata(t *testing.T) {
	...
	expectedTypeName := "netbox_wireless_lan_group"
