...
func TestManufacturerDataSource(t *testing.T) {
	d := NewManufacturerDataSource()
	if d == nil {
		t.Fatal("Manufacturer data source should not be nil")
	}
}
...
func TestManufacturerDataSourceSchema(t *testing.T) {
	...
	expectedAttrs := []string{"id", "name", "slug", "description"}
...
func TestManufacturerDataSourceMetadata(t *testing.T) {
	...
	expectedTypeName := "netbox_manufacturer"
