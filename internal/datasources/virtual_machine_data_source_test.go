...
func TestVirtualMachineDataSource(t *testing.T) {
	d := NewVirtualMachineDataSource()
	if d == nil {
		t.Fatal("VirtualMachine data source should not be nil")
	}
}
...
func TestVirtualMachineDataSourceSchema(t *testing.T) {
	...
	expectedAttrs := []string{"id", "name", "cluster", "status", "site", "tenant", "description", "tags", "custom_fields"}
...
func TestVirtualMachineDataSourceMetadata(t *testing.T) {
	...
	expectedTypeName := "netbox_virtual_machine"
