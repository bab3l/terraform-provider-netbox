...
func TestAccInventoryItemDataSource_basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccInventoryItemDataSourceConfig,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.netbox_inventory_item.test", "name", "Test Item"),
...
const testAccInventoryItemDataSourceConfig = `
