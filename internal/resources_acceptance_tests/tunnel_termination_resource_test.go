		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("netbox_tunnel_termination.test", "tags.#", "2"),
					resource.TestCheckTypeSetElemAttr("netbox_tunnel_termination.test", "tags.*", tag1Slug),
					resource.TestCheckTypeSetElemAttr("netbox_tunnel_termination.test", "tags.*", tag2Slug),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttr("netbox_tunnel_termination.test", "tags.*", tag3Slug),
				),
			},
			{
