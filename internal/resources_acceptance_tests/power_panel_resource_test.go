		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttr("netbox_power_panel.test", "tags.*", tag1Slug),
					resource.TestCheckTypeSetElemAttr("netbox_power_panel.test", "tags.*", tag2Slug),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttr("netbox_power_panel.test", "tags.*", tag3Slug),
				),
			},
			{
