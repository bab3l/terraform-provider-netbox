...
func TestInterfacesDataSourceSchema(t *testing.T) {
	...
	testutil.ValidateDataSourceSchema(t, resp.Schema.Attributes, testutil.DataSourceValidation{
		LookupAttrs:   []string{},
		ComputedAttrs: []string{"ids", "names", "interfaces"},
	})
...
func TestInterfacesDataSourceMetadata(t *testing.T) {
	t.Parallel()

	d := datasources.NewInterfacesDataSource()
	testutil.ValidateDataSourceMetadata(t, d, "netbox", "netbox_interfaces")
}

func TestInterfacesDataSourceConfigure(t *testing.T) {
	t.Parallel()
