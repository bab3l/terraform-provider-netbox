...
func TestDevicesDataSourceSchema(t *testing.T) {
	t.Parallel()

	d := datasources.NewDevicesDataSource()
	...
	testutil.ValidateDataSourceSchema(t, resp.Schema.Attributes, testutil.DataSourceValidation{
		LookupAttrs:   []string{},
		ComputedAttrs: []string{"ids", "names", "devices"},
	})
...
func TestDevicesDataSourceMetadata(t *testing.T) {
	t.Parallel()

	d := datasources.NewDevicesDataSource()
	testutil.ValidateDataSourceMetadata(t, d, "netbox", "netbox_devices")
}

func TestDevicesDataSourceConfigure(t *testing.T) {
	t.Parallel()
