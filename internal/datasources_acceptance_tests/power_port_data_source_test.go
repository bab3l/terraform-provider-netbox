...
func TestAccPowerPortDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccPowerPortDataSourceConfig,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.netbox_power_port.test", "name", "Test Power Port"),
...
const testAccPowerPortDataSourceConfig = `
