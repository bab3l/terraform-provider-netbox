// package datasources_acceptance_tests contains safety tests for data sources to prevent common issues.

//

// These tests verify:

// 1. Data sources have proper search attributes (id, name, slug)

// 2. Required fields are correctly marked

// 3. All data sources follow consistent patterns
