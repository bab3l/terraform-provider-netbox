...
func TestAccWirelessLANDataSource_byID(t *testing.T) {
...
func TestAccWirelessLANDataSource_bySSID(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccWirelessLANDataSourceBySSIDConfig(ssid),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.netbox_wireless_lan.test", "ssid", ssid),
					resource.TestCheckResourceAttrSet("data.netbox_wireless_lan.test", "id"),
				),
...
func testAccWirelessLANDataSourceByIDConfig(ssid string) string {
	return fmt.Sprintf(`
