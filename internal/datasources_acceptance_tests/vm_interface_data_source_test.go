...
func TestAccVMInterfaceDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVMInterfaceDataSourceConfig(clusterTypeName, clusterTypeSlug, clusterName, vmName, interfaceName),
...
func testAccVMInterfaceDataSourceConfig(clusterTypeName, clusterTypeSlug, clusterName, vmName, interfaceName string) string {
	return fmt.Sprintf(`
