...
func TestAccConsolePortDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccConsolePortDataSourceConfig("console0"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.netbox_console_port.test", "name", "console0"),
...
func testAccConsolePortDataSourceConfig(name string) string {
	return fmt.Sprintf(`
